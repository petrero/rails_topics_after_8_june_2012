...
describe Announcement do
  it "has current scope" do
	...
	it "does not include ids passed in to current" do
		current_1 = Announcement.create! starts_at: 1.hour.ago, ends_at: 1.day.from_now
		current_2 = Announcement.create! starts_at: 1.hour.ago, ends_at: 1.day.from_now
		Announcement.current([current_2.id]).should eq([current_1])
	end
